...
import { Box, Button, FormControl, Text, FormErrorMessage, FormHelperText, Heading, IconButton, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Slide, SlideFade, Stack, useDisclosure, useToast, VStack, FormLabel, HStack, AspectRatio, Center } from "@chakra-ui/react"
            ...
            <Box pos='fixed' right={3} bottom={3} >
                <SlideFade in={isOpen}>
                    <Stack bg='themeGreen.500' p={4} pr={6}>
                        <Heading color='whit' fontSize={'2xl'}>Af en toe een inzicht in je inbox?</Heading>
                        <Button colorScheme={'whiteAlpha'} onClick={onOpenModal}>Schrijf je in op mijn nieuwsbrief!</Button>
                        <IconButton onClick={onClose} pos='absolute' size='xs' borderRadius='0' top={-2} right={0} colorScheme={'whiteAlpha'} icon={<CloseIcon boxSize={2} />} aria-label='Sluit niewusbrief widget' />
                    </Stack>
                </SlideFade>
            </Box>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <ModalBody>
                            <AwareStack spacing={5}>
                                <Center p={5}>
                                    <AspectRatio ratio={1} w={36} bg='themeGreen.50' p={5} borderRadius='full' >
                                        <Box>
                                ...
                                <Stack spacing={6} flex={1}>
                                    ...
                                    <Box>
                                    <Button colorScheme={'themeGreen'} isLoading={isSubmitting} type="submit">
                                        Inschrijven
                                    </Button>
                                    </Box>
                                </Stack>
